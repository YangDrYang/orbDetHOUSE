...
process_rmse <- function() {
    ...
    for (j in 1:trials) {
        ...
        tru_file <- paste("out_simpleModel/tru_",  j, ".csv", sep="")

        house_file <- paste("out_simpleModel/house_", j, ".csv", sep="")
        ukf_file   <- paste("out_simpleModel/ukf_",  j, ".csv", sep="")
        cut4_file  <- paste("out_simpleModel/cut4_", j, ".csv", sep="")
        cut6_file  <- paste("out_simpleModel/cut6_", j, ".csv", sep="")
    ...
    file <- paste("out_simpleModel/rmse",  ".csv", sep="")
    ...
    file <- paste("out_simpleModel/rmse_t", ".csv", sep="")
    ...
    file <- paste("out_simpleModel/conv", ".csv", sep="")
...
process_box <- function() {
    ...
    for (j in 1:trials) {
        ...
        tru_file <- paste("out_simpleModel/tru_", "_",  j, ".csv", sep="")

        house_file <- paste("out_simpleModel/house_", k, ".csv", sep="")
        ukf_file   <- paste("out_simpleModel/ukf_",   k, ".csv", sep="")
        cut4_file  <- paste("out_simpleModel/cut4_",  k, ".csv", sep="")
        cut6_file  <- paste("out_simpleModel/cut6_",  k, ".csv", sep="")
    ...
    pos_file <- paste("out_simpleModel/pos_err_", ".csv", sep="")
    vel_file <- paste("out_simpleModel/vel_err_", ".csv", sep="") 
