...
process_rmse <- function(dist) {
    ...
    for (j in 1:trials) {
        ...
        tru_file <- paste("out/out_projectile/tru_", dist, "_", j, ".csv", sep = "")
    ...
    file <- paste("out/out_projectile/rmse_", dist, ".csv", sep = "")
    ...
    file <- paste("out/out_projectile/rmse_t_", dist, ".csv", sep = "")
    ...
    file <- paste("out/out_projectile/conv_", dist, ".csv", sep = "")
...
process_box <- function(dist) {
    ...
    pos_file <- paste("out/out_projectile/pos_err_", dist, ".csv", sep = "")
    vel_file <- paste("out/out_projectile/vel_err_", dist, ".csv", sep = "")
