...
pos_err_gauss <- as.matrix(read.csv("out/out_projectile/pos_err_gauss.csv"))
vel_err_gauss <- as.matrix(read.csv("out/out_projectile/vel_err_gauss.csv"))

pos_err_pearson <- as.matrix(read.csv("out/out_projectile/pos_err_pearson.csv"))
vel_err_pearson <- as.matrix(read.csv("out/out_projectile/vel_err_pearson.csv"))
...
dst <- c(
      rep("Gaussian Distributions", 8 * Ng),
