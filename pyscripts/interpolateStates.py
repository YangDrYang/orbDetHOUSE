...
for index, row in meas_df.iterrows():
    ...
    data_points_x = [
        DataPoint(x, y) for x, y in zip(nearest_points["MJD"], nearest_points["X_ECI"])
    ]
    data_points_y = [
        DataPoint(x, y) for x, y in zip(nearest_points["MJD"], nearest_points["Y_ECI"])
    ]
    data_points_z = [
        DataPoint(x, y) for x, y in zip(nearest_points["MJD"], nearest_points["Z_ECI"])
    ]
    data_points_vx = [
        DataPoint(x, y) for x, y in zip(nearest_points["MJD"], nearest_points["VX_ECI"])
    ]
    data_points_vy = [
        DataPoint(x, y) for x, y in zip(nearest_points["MJD"], nearest_points["VY_ECI"])
    ]
    data_points_vz = [
        DataPoint(x, y) for x, y in zip(nearest_points["MJD"], nearest_points["VZ_ECI"])
    ]
